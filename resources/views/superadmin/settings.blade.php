            ...
            <div class="bg-card border border-border rounded-2xl overflow-hidden">
                <div class="px-6 py-5 border-b border-border flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <span
                            class="inline-flex items-center gap-1.5 mt-1 px-2.5 py-0.5 bg-navy-100 text-navy-700 text-xs font-semibold rounded-full">
                            <span class="w-1.5 h-1.5 bg-navy-600 rounded-full"></span>
                            Super Admin
                        </span>
                    </div>
                </div>
            ...
            <div class="mt-6 bg-card border border-border rounded-2xl px-6 py-5">
                ...
                <dl class="space-y-3">
                    <div class="flex items-center justify-between py-2 border-b border-border/50">
                        ...
                        <dd>
                            <span
                                class="inline-flex items-center gap-1.5 px-2.5 py-0.5 bg-success-bg text-success text-xs font-semibold rounded-full">
