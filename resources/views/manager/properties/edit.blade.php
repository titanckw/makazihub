                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="landlord_tax_status" required
                            class="w-full px-4 py-2.5 rounded-xl border border-border bg-white text-primary focus:outline-none focus:ring-2 focus:ring-brand-500 transition-all">
                            <option value="resident" {{ old('landlord_tax_status', $property->landlord_tax_status) == 'resident' ? 'selected' : '' }}>Resident</option>
                            <option value="non_resident" {{ old('landlord_tax_status', $property->landlord_tax_status) == 'non_resident' ? 'selected' : '' }}>Non-Resident</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-600 text-primary mb-1.5">Landlord KRA PIN</label>
                        <input type="text" name="landlord_pin" value="{{ old('landlord_pin', $property->landlord_pin) }}"
                            class="w-full px-4 py-2.5 rounded-xl border border-border bg-white text-primary focus:outline-none focus:ring-2 focus:ring-brand-500 transition-all">
                    </div>
                </div>

                <label class="flex items-center gap-2 mt-3 text-sm text-primary">
                    <input type="checkbox" name="is_vat_registered" value="1" {{ old('is_vat_registered', $property->is_vat_registered) ? 'checked' : '' }}
