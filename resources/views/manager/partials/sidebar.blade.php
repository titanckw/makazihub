...
<a href="{{ route('manager.maintenance.index') }}"
   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-colors
    ...
    <span class="ml-auto bg-amber-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full">{{ $maintenanceCount }}</span>
    @endif
</a>
...
<a href="{{ route('manager.invoices.index') }}"
   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-colors
    ...
    @if($overdueCount > 0)
    <span class="ml-auto bg-danger text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full">{{ $overdueCount }}</span>
    @endif
</a>
